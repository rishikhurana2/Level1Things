...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed == firstButton) {
			...
			askQuestion("What's my name", "Rishi", 200);
			firstButton.setText("");
		...
		if (buttonPressed == secondButton) {
			...
			askQuestion("The answer to this question is what you do frequently", "what you do frequently", 400);
			// Clear the button text (set the button text to nothing)
			secondButton.setText("");
		}
		if (buttonPressed == thirdButton) {
			askQuestion("What number is your pencil", "No. 2", 600);
			thirdButton.setText("");
		}
		if (buttonPressed == fourthButton) {
			askQuestion("How do you say I in spanish", "Yo", 800);
			fourthButton.setText("");
		}
		if (buttonPressed == fifthButton) {
			askQuestion("How old am I", "14", 1000);
			fifthButton.setText("");
		}
	}
